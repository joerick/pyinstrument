...
def x_strip_ipython_frames_processor__mutmut_orig(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
...
def x_strip_ipython_frames_processor__mutmut_1(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
...
def x_strip_ipython_frames_processor__mutmut_2(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
    ...
    for child in frame.children:
        strip_ipython_frames_processor(None, options=options)
...
def x_strip_ipython_frames_processor__mutmut_3(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
    ...
    for child in frame.children:
        strip_ipython_frames_processor(child, options=None)
...
def x_strip_ipython_frames_processor__mutmut_4(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
    ...
    for child in frame.children:
        strip_ipython_frames_processor(options=options)
...
def x_strip_ipython_frames_processor__mutmut_5(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
    ...
    for child in frame.children:
        strip_ipython_frames_processor(child, )
...
def x_strip_ipython_frames_processor__mutmut_6(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
    ...
    for child in frame.children:
        ...
        if child.file_path is not None or any(
            f in child.file_path for f in IPYTHON_INTERNAL_FILES
        ):
            delete_frame_from_tree(child, replace_with="children")
            break
...
def x_strip_ipython_frames_processor__mutmut_7(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
    ...
    for child in frame.children:
        ...
        if child.file_path is None and any(
            f in child.file_path for f in IPYTHON_INTERNAL_FILES
        ):
            delete_frame_from_tree(child, replace_with="children")
            break
...
def x_strip_ipython_frames_processor__mutmut_8(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
def x_strip_ipython_frames_processor__mutmut_9(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
    ...
    for child in frame.children:
        ...
        if child.file_path is not None and any(
            f not in child.file_path for f in IPYTHON_INTERNAL_FILES
        ):
            delete_frame_from_tree(child, replace_with="children")
            break
...
def x_strip_ipython_frames_processor__mutmut_10(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
def x_strip_ipython_frames_processor__mutmut_11(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
def x_strip_ipython_frames_processor__mutmut_12(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
def x_strip_ipython_frames_processor__mutmut_13(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
def x_strip_ipython_frames_processor__mutmut_14(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
def x_strip_ipython_frames_processor__mutmut_15(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
def x_strip_ipython_frames_processor__mutmut_16(frame: Frame | None, options: ProcessorOptions) -> Frame | None:
    """
    A processor function that removes internal IPython nodes.
    """
    if frame is None:
...
x_strip_ipython_frames_processor__mutmut_mutants : ClassVar[MutantDict] = {
'x_strip_ipython_frames_processor__mutmut_1': x_strip_ipython_frames_processor__mutmut_1, 
    'x_strip_ipython_frames_processor__mutmut_2': x_strip_ipython_frames_processor__mutmut_2, 
    'x_strip_ipython_frames_processor__mutmut_3': x_strip_ipython_frames_processor__mutmut_3, 
    'x_strip_ipython_frames_processor__mutmut_4': x_strip_ipython_frames_processor__mutmut_4, 
    'x_strip_ipython_frames_processor__mutmut_5': x_strip_ipython_frames_processor__mutmut_5, 
    'x_strip_ipython_frames_processor__mutmut_6': x_strip_ipython_frames_processor__mutmut_6, 
    'x_strip_ipython_frames_processor__mutmut_7': x_strip_ipython_frames_processor__mutmut_7, 
    'x_strip_ipython_frames_processor__mutmut_8': x_strip_ipython_frames_processor__mutmut_8, 
    'x_strip_ipython_frames_processor__mutmut_9': x_strip_ipython_frames_processor__mutmut_9, 
    'x_strip_ipython_frames_processor__mutmut_10': x_strip_ipython_frames_processor__mutmut_10, 
    'x_strip_ipython_frames_processor__mutmut_11': x_strip_ipython_frames_processor__mutmut_11, 
    'x_strip_ipython_frames_processor__mutmut_12': x_strip_ipython_frames_processor__mutmut_12, 
    'x_strip_ipython_frames_processor__mutmut_13': x_strip_ipython_frames_processor__mutmut_13, 
    'x_strip_ipython_frames_processor__mutmut_14': x_strip_ipython_frames_processor__mutmut_14, 
    'x_strip_ipython_frames_processor__mutmut_15': x_strip_ipython_frames_processor__mutmut_15, 
    'x_strip_ipython_frames_processor__mutmut_16': x_strip_ipython_frames_processor__mutmut_16
}

def strip_ipython_frames_processor(*args, **kwargs):
    result = _mutmut_trampoline(x_strip_ipython_frames_processor__mutmut_orig, x_strip_ipython_frames_processor__mutmut_mutants, args, kwargs)
    return result 

strip_ipython_frames_processor.__signature__ = _mutmut_signature(x_strip_ipython_frames_processor__mutmut_orig)
x_strip_ipython_frames_processor__mutmut_orig.__name__ = 'x_strip_ipython_frames_processor'
